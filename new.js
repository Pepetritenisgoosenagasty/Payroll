        ...
        if (r_shortage == "") {
            ...
            console.log("amt_rer3: " + r_pay_due_kodson);
              ...
              //  r_amt_recievable = r_pay_due_kodson;
                ...
                $("#r_amt_recievable").val(r_pay_due_kodson);
...
//                    var y = $("#r_amt_recievable").val();
                  //  var w = $("#r_amt_recievable_surchage").val();
                    console.log("amt_rer: " + r_amt_recievable);
                    
                    x = parseFloat(parseFloat(r_amt_recievable) + parseFloat(r_cash_paid_to_make_loss)).toFixed(2);
                    t = parseFloat(parseFloat(r_amt_recievable) + parseFloat(r_cash_paid_to_make_loss)).toFixed(2);

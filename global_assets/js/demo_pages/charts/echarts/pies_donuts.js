    ...
    var _piesDonutsExamples = function () {
        ...
        if (pie_rose_element) {
            ...
            $.post("/payroll/includes/sys_config", {
                ...
                var r = JSON.parse(r);
                var dates = r.category;
                var vals = r.values.length;
                var arr = [];
                
                for( var i = 0; i < vals; i++){
                    var item = {value:r.values[i] , name:r.name[i]};
                    arr.push(item);
                }
                            // Options
            pie_rose.setOption({
                ...
                // Add title
                title: {
                    text: 'Employee\'s Category HeadCount',
                    subtext: '',
                    left: 'center',
                    textStyle: {
                        fontSize: 17,
                ...
                tooltip: {
                    ...
                    formatter: '{a} <br/>{b}: {c} employee(s) ({d}%)'
                },
        ...
        if (pie_multiples_element) {
            ...
            pie_multiples.setOption({
                ...
                // Add title
                title: {
                    text: 'Disk Space On Server',
                    subtext: 'Available Space On Disk',
                    top: 'center',
                    textStyle: {
                        fontSize: 17,
                        fontWeight: 500

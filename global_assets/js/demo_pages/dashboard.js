...
//                    '</ul>';
            ...
            d3.select(points[0][0])
                .on('mouseover', function (d) {
                    tooltip.offset([0, 10]).direction('e').hide(d);
            ...
            d3.select(points[0][points.size() - 1])
                .on('mouseover', function (d) {
                    tooltip.offset([0, -10]).direction('w').hide(d);
...
//            }
    ...
    return {
        ...
        initCharts: function() {
            ...
            //element, radius, border, color, end, iconClass, textTitle, textAverage
            _RoundedProgressChart('#hours-available-progress', 38, 2, '#F06292', 0.50, 'icon-watch text-pink-400', 'Hours available', '64% average');
            ...
            // Bar charts //element, barQty, height, animate, easing, duration, delay, color, tooltip
            ...
            _BarChart('#members-online', setInterval(function(){Math.floor((Math.random()*10)+1)}, 2000), 50, true, 'elastic', 1200, 50, 'rgba(255,255,255,0.5)', 'members');

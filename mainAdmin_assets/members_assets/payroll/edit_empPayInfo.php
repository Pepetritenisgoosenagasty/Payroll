...
if(isset($_REQUEST['__i_g_']) && isset($_REQUEST['_f__st'])){
    $valStore = $_REQUEST['__i_g_'];
    $valemp = $_REQUEST['_f__st'];
    $val = base64_decode($valStore);
    $val2 = base64_decode($valemp);
    $totBasicPay = 0;
    $totDeductions = 0;
    $totNetSalary = 0;
    ...
    $query = "SELECT * FROM `employees` AS emp 
                ...
                WHERE emp.`emp_id`='$val2' AND pr.`id`='$val'";
...
<!--                        <h4>EDIT PAYROLL</h4>-->
                                ...
                                <div class="col-md-12">
                                    <fieldset>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4">
                                                <input readonly readonly type="text" name="eempCatName" id="eempSsnit" value="<?= $cat_name; ?>" class="form-control">
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <fieldset>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4">
                                        <input readonly type="text" id="eempbasic" name="eempBasic" value="<?= sprintf("%0.2f",$basicPay); ?>" class="form-control numbersonly-format">
                                            </div>
        ...
        <input readonly type="text" name="eempCurLoanSur" id="eempCurLoanSur" value="<?= sprintf("%0.2f",$empCurrent_loans_surcharges); ?>" class="form-control numbersonly-format">
                                ...
                                <div class="col-md-12">
                                    <fieldset>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4">
                                                <input readonly type="text" name="eempDeduct" id="eempDeduct" value="<?= sprintf("%0.2f",$empdeductions); ?>" class="form-control numbersonly-format">
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <fieldset>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4">
                                                <input readonly type="text" name="eempPaye" id="eempPaye" value="<?= sprintf("%0.2f",$empPaye); ?>" class="form-control numbersonly-format">
                                            </div>

                                            <label class="col-lg-2 col-form-label"><b>Bicycle Deductions:</b></label>
                                            <div class="col-lg-4">
                                                <input readonly type="text" name="eempBicyc" id="eempBicyc" value="<?= sprintf("%0.2f",$emp_bicycle_deduction); ?>" class="form-control numbersonly-format">
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="row" style="margin:10px;">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input disabled type="radio" class="custom-control-input" name="tax" value="emp" id="allow_emp">
                                        <label class="custom-control-label" for="allow_emp">Use Employee (<span id="taxEmpP">
                                                <?= sprintf("%0.2f",$emptaxPer); ?></span>%)</label>
                                    </div>

                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input disabled type="radio" class="custom-control-input" name="tax" value="empler" id="allow_empler">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly type="text" name="eempPayMethod" id="eempPayMethod" value="<?= $payment_method; ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly type="text" name="eempDescrp" id="eempDescrp" value="<?= $emp_description; ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label><b>Paid Amount:</b></label>
                                                    <input readonly type="text" name="eempPaidAmt" id="eempPaidAmt" value="<?= sprintf(" %0.2f",$empNetSalPay); ?>" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly type="text" id="eempcomment" name="eempcomment" value="<?= $comment; ?>" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                     ...
                     <button disabled type="button" id="update_Slip" onclick="updateSlipSlip()" class="btn bg-primary"><span id="updateSlip" class="ladda-label labll">Update</span><i class="icon-reset ml-2 updateSlip"></i></button>
                            </div>
                        </form>
                    </div>
                </div>

...
<?php
    ...
    $query = "SELECT * FROM `trips_history`";
                                ...
                                <div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
                                    ...
                                    <form action="<?= $_SERVER['PHP_SELF']; ?>" class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-12">
                                                <select name="shortage_value" id="shortage_value" class="form-control shortage">
                                                    <?php
                                                $query = mysqli_query($vSky, "SELECT DISTINCT DATE_FORMAT(`discharging_date`,'%Y-%m') AS yearmonth FROM `trips_history`");
                                                    $now = date("Y-m-d");
                                                    $exploded_now = explode("-", $now);
                                                    $e = $exploded_now[0];
                                                while($fetch = mysqli_fetch_assoc($query)){
                                                    $month_name = $fetch['yearmonth'];
                                                    $exploded = explode("-", $month_name);
                                                    $yearr = $exploded[0];
                                        ...
                                        <div class="col" style="margin-left:-10px; margin-top:35px;">
                                            <button type="button" data-toggle="modal" data-target="#for_shortage_values" id="shortage_value_btn" class="btn btn-outline-success"><i class="icon-cursor2 mr-2"></i> <span class="ladda-label labllPay mr-2">Click</span> </button>
                                        </div>
                                    </form>
                                    ...
                                    <form class="row" style="margin-left:55px;">
                                        ...
                                        <div class="col" style="margin-left:-5px; margin-top:35px;">
                                            <button type="button" id="getShortageVariablesInfo" class="btn btn-light" data-toggle="modal" data-target="#modal_form_vertical"><i class="icon-touch mr-2"></i> <span class="ladda-label labllPay mr-2">Click</span> </button>
                                        </div>
                                    </form>
                                    ...
                                    <form class="row" style="margin-left:25px;">
                                        ...
                                        <div class="col" style="margin-left:-10px; margin-top:35px;">
                                            <button type="button" id="overNytbtn" class="btn btn-outline-warning" data-toggle="modal" data-target="#over_nyt_expensis"><i class="icon-select2 mr-2"></i> <span class="ladda-label labllPay mr-2">Click</span> </button>
                                        </div>
                                    </form>
                                        ...
                                        <div class="form-group row" style="margin-left:-25px;">
                                            ...
                                            <div class="col-lg-5" style="margin-left:-20px;">
                                                <select class="form-control report_com_name" name="r_c_n" id="r_c_n">
                                                    <?php
                                         $query = mysqli_query($vSky, "SELECT DISTINCT `sub_company_name` FROM `trips_history`");
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group row" >
                                            ...
                                            <div class="col-lg-5" style="margin-left:-55px;">
                                                <select class="form-control report_dPt" name="dPt" id="dPt">
                                                    <option value="pdt"> -- Select -- </option>

                                                          <?php
                                            $query = mysqli_query($vSky, "SELECT DISTINCT `discharging_pt` FROM `trips_history`");
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="text-right" style="margin-left:10px;">
                                               <input type="hidden" id="requested_vals" value="<?= $_REQUEST['r_c_n']; ?>">
                                                <button type="button" id="print_shortage" class="btn btn-warning" data-target="#over_nyt_expensis" data-toggle="modal">Print<i class="icon-printer ml-2"></i></button>
                                            </div>
                ...
                <div class="card">
                    ...
                    <table class="table datatable-scroll-y" id="recordsTable2" width="100%" style="margin-left:0px; width:1380px;">
                        ...
                        if( isset($_REQUEST['r_c_n']) && !empty($_REQUEST['r_c_n']) && isset($_REQUEST['year_month']) && !empty($_REQUEST['year_month']) ){
                            ...
                            $vSkyStmt = mysqli_query($vSky, "SELECT * FROM `trips_history` WHERE `sub_company_name`='NONAME' AND `discharging_date` BETWEEN '0000-00-00' AND '0000-00-00'");
                                
                            }else{
                                
                                if($dPt == "pdt" && $other_dPt == "non"){
                                                                      
                                    $vSkyStmt = mysqli_query($vSky, "SELECT * FROM `trips_history` WHERE `sub_company_name`='$r_c_n' AND DATE_FORMAT(`discharging_date`,'%Y-%m')='$year_month'");
                                    
                                }else if( $dPt != "pdt" && $other_dPt == "non" ){
                                    
                                  $vSkyStmt = mysqli_query($vSky, "SELECT * FROM `trips_history` WHERE `sub_company_name`='$r_c_n' AND `discharging_pt`='$dPt' AND DATE_FORMAT(`discharging_date`,'%Y-%m')='$year_month'");  
                                    
                                }else if( $dPt != "pdt" && $other_dPt != "non" ){
                                    
                                    $vSkyStmt = mysqli_query($vSky, "SELECT * FROM `trips_history` WHERE `sub_company_name`='$r_c_n' AND (`discharging_pt`='$dPt' OR `discharging_pt`='$other_dPt') AND (DATE_FORMAT(`discharging_date`,'%Y-%m')='$year_month')");
                           ...
                           while($vSkyRow = mysqli_fetch_assoc($vSkyStmt)){
                            ...
                            <tr id='row_<?= e($vSkyRow['id']); ?>' style="color:red;">
                                ...
                                <td class="text-center">
                                    <div class="list-icons">
                                        <button type="button" data-target="#over_nyt_expensis" onclick="gettripHistoryInfo(<?= e($vSkyRow['id']); ?>)" id="viewRemainingInfo" data-toggle="modal" class="list-icons-item btn btn-light">
